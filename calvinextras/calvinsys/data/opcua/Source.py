...
class ChangeHandler(object):
    ...
    def datachange_notification(self, node, val, data):
        ...
        asynchronous.call_from_thread(self.notify, value)
...
class Source(base_calvinsys_object.BaseCalvinsysObject):
    ...
    def init(self, endpoint, paramconfig, namespace, timeout, monitoring_interval, logging_interval=None, reconnect_interval=60, tags=None):
        ...
        if logging_interval:
            ...
            self.stat_logger = asynchronous.DelayedCall(logging_interval, show_stats)
        ...
        def watchdog(parameter):
            ...
            def result(failure=None):
                if not failure:
                    ...
                    self.watchdog = asynchronous.DelayedCall(timeout, watchdog, parameter)
                    # Alert the scheduler
                    self.scheduler_wakeup()
                else:
        ...
        def connect_and_subscribe():
            ...
            try:
                ...
                asynchronous.DelayedCall(reconnect_interval, setup)
            except Exception as e:
        ...
        def setup_done(client_param_subscr_tuple):
            (client, parameter, subscription) = client_param_subscr_tuple
            self.client = client

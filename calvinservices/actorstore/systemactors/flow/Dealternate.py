...
class Dealternate(Actor):
    """
    documentation:
    - Route tokens to the ports connected to the fan-out port token in the order given
      by the argument 'order'
    ports:
    - direction: in
      help: Any token
      name: token
    - direction: out
      help: Dispatching tokens to connected ports in order
      name: token
      properties:
